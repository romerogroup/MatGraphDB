...
from matgraphdb.stores import GraphStore, MaterialNodes
...
class MatGraphDB(GraphStore):
    ...
    def __init__(self, storage_path: str, load_custom_stores: bool=True):
        ...
        super().__init__(storage_path=self.storage_path, load_custom_stores=load_custom_stores)
        ...
        if not self.node_exists("materials"):
            ...
            logger.info("Material nodes do not exist. Adding empty materials node store")
