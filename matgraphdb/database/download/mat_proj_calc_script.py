...
def process_entry(file,save_dir=os.path.join(DATA_DIR,'data','raw','mp_database_nelements_7_calcs')):
...
def process_database(n_cores=1):
    ...
    database_dir=os.path.join(DATA_DIR,'data','raw','mp_database_nelements_7')
