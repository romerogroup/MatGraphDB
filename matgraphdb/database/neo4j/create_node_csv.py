...
from matgraphdb.database.neo4j.node_types import (ELEMENTS,ELEMENT_PROPERTIES, MAGNETIC_STATES, CRYSTAL_SYSTEMS, CHEMENV_NAMES,
...
from matgraphdb.database.json.utils import PROPERTIES
