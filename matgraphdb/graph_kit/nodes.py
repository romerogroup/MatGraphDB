...
class Nodes:
    ...
    def get_dataframe(self, columns=None, include_cols=True, from_scratch=False, **kwargs):
        """
        Main method to load or create nodes. The creation logic will be implemented by subclasses.
        """
    ...
    def create_nodes(self, **kwargs):
        """
        Abstract method for creating nodes. To be implemented by subclasses.
        """
    ...
    def save_dataframe(self, df, filepath):
        """
        Save the nodes to a parquet file.
        """
        try:
