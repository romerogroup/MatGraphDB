...
from matgraphdb.mlcore.callbacks import EarlyStopping, MetricsTacker, Checkpointer
from matgraphdb.mlcore.models import WeightedRandomClassifier, MajorityClassClassifier
from matgraphdb.utils import ML_DIR,ML_SCRATCH_RUNS_DIR
from matgraphdb.utils import LOGGER

class Trainer:
    def __init__(self,train_dataset, test_dataset, model, loss_fn, optimizer, device, run_path=ML_SCRATCH_RUNS_DIR, run_name='scratch',
                 batch_size=64,
                 max_iters=100,
