...
df = material_store.read(columns=["elasticity.g_vrh", "elasticity.k_vrh", 
                                     "core.volume", "core.density", 
                                     "core.density_atomic", "core.nelements", 
                                     "core.nsites"],
                            filters=[
...
z = df[["core.volume", "core.density", "core.density_atomic", 
        "core.nelements", 
        # "core.nsites"
        ]]
