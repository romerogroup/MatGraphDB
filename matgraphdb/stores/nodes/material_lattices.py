...
class MaterialLatticeNodes(NodeStore):
    ...
    def initialize(self, material_nodes_path='data/nodes/materials'):
        ...
        try:
            ...
            table=material_nodes.read(columns=['structure.lattice.a', 'structure.lattice.b', 'structure.lattice.c', 
                                                'structure.lattice.alpha', 'structure.lattice.beta', 'structure.lattice.gamma', 
                                                'structure.lattice.volume','structure.lattice.pbc', 'structure.lattice.matrix',
                                                'id', 'core.material_id'])
