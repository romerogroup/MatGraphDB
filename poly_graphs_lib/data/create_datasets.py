...
def create_plutonic_dataset(data_dir:str, feature_set_index:int, val_size:float=0.20):
    ...
    ##########################################################################################################
    feature_dir = data_dir + os.sep + 'plutonic_polyhedra' + os.sep + f'feature_set_{feature_set_index}'
