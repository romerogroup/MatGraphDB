...
def main():
    ...
    # generator.screen_graph_database('nelements-1-2',nelements=(1,2), from_scratch=True)
    generator.screen_graph_database('nelements-1-3',nelements=(1,3), from_scratch=True)
    generator.screen_graph_database('nelements-1-4',nelements=(1,4), from_scratch=True)
    generator.screen_graph_database('nelements-1-5',nelements=(1,5), from_scratch=True)
