...
from poly_graphs_lib.pyg_json_pair_dataset import PolyhedraPairDataset
...
train_dataset = PolyhedraPairDataset(database_dir=train_dir,device=device)
test_dataset = PolyhedraPairDataset(database_dir=test_dir,device=device)

y_train_vals = []
n_graphs = len(train_dataset)
for data in train_dataset:
    # print(data)
    y_train_vals.append(data[0].y)
