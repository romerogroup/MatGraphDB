...
from matgraphdb.models.coord_env.classify.model import PolyhedronResidualModel
from matgraphdb.data.dataset import MPPolyDataset
from trash.callbacks import EarlyStopping

from matgraphdb.utils.plotting import plot_training_curves
from matgraphdb.utils.timing import Timer
from matgraphdb.utils.torch_utils import get_total_dataset_bytes,get_model_bytes
from matgraphdb.cfg.coordination_geometries_files import mp_symbols

class_labels=list(mp_symbols.keys())
...
class Trainer:
    ...
    def plot_value_per_class(self,df,savefig=None, name='Accuracy'):
    ...
    def save_training(self):
        ...
        self.plot_value_per_class(df,savefig=f'{self.run_dir}{os.sep}class_acc.png', name='Accuracy')
        ...
        self.plot_value_per_class(df,savefig=f'{self.run_dir}{os.sep}class_distribution.png', name='Class Distribution')
        ...
        self.plot_value_per_class(df,savefig=f'{self.run_dir}{os.sep}weighted_random_class_acc.png', name='Weighted Random Accuracy')
