...
def main():
    ...
    test_verts = []
    test_verts.append(verts_tetra)
    test_verts.append(verts_cube)
    test_verts.append(verts_oct)
    test_verts.append(verts_dod)
    test_verts.append(verts_tetra_rot)
    ...
    test_indices = np.arange(0,len(test_verts))
    
    train_combinations = list(itertools.combinations_with_replacement(train_indices,2))
    val_combinations = list(itertools.combinations_with_replacement(val_indices,2))
    test_combinations = list(itertools.combinations_with_replacement(test_indices,2))
    print(len(train_combinations))
    print(len(val_combinations))
    ...
    collect_data(polyhedra_verts=test_verts,combination_indices=test_combinations, save_dir=test_dir,polyhedra_dir=polyhedra_dir)
