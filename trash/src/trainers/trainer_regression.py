...
from poly_graphs_lib.models.poly.poly_regression_model import PolyhedronRegressionModel
from matgraphdb.utils.plotting import plot_training_curves
from matgraphdb.utils.math_dataset import target_statistics
...
from matgraphdb.utils.metrics import compare_polyhedra
from matgraphdb.utils import ROOT,PROJECT_DIR
...
class Trainer:
    ...
    def initialize_model(self):
        ...
        self.model = PolyhedronRegressionModel(n_node_features=self.n_node_features, 
...
def main():
    print(PROJECT_DIR)
    config_file = os.path.join(PROJECT_DIR,'src','poly_graphs_lib','cfg','sample_regression.yml') 
